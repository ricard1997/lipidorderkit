...
import lipidorder  # noqa



# -- Project information -----------------------------------------------------

project = "lipidorderkit"
copyright = (
    "2024, Ricardo Ramirez. "
...
htmlhelp_basename = "lipidorderkitdoc"
...
latex_documents = [
    (master_doc, "lipidorderkit.tex", "lipidorderkit Documentation",
     "lipidorderkit", "manual"),
]
...
man_pages = [
    (master_doc, "lipidorderkit", "lipidorderkit Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "lipidorderkit", "lipidorderkit Documentation",
     author, "lipidorderkit", "Program designed to compute order parameters for all atom MD simulations",
     "Miscellaneous"),
]
